...
public final class misAccesosArbol_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 atad.defina.datos.AccesoDatosBase dao = null;Object codOperacion=null; Object codOperacionLigera=null;
  ...
  if(atad.defina.entorno.Configuracion.getCfg("cfg.acceso.usuario").toString().equals(tipoAcceso)){
      ...
      out.write("\t}else if(esOpcionColgable(filaSel[0])){//Si intenta modificar la operación Mis accessos\r\n");
      out.write("\t\talert(\"No se puede modificar la operacion Mis accesos.\");\r\n");
      out.write("\t} else {\r\n");
      ...
      out.write("\r\n");
      out.write("\tif (strCodigoComparacion == \"MISACC\" || strCodigoComparacion == \"MISACCL\"){\r\n");
      ...
      out.write("\t\t\talert(\"Sólo se pueden colgar elementos en 'Mis Accesos'.\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t// END DEFINA\r\n");
      out.write("\tvar rc = mostrarDialogoMisAccesos();\r\n");
      out.write("\tif (filaSel == null){\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function mostrarDialogoMisAccesos() {\r\n");
      out.write("\t\r\n");
      ...
      out.write("  <tr>\r\n");
      out.write("    <td height=\"22\" class=\"CabeceraRelacionada2\">&nbsp;&nbsp;MIS ACCESOS :: Modificar :: Ver &aacute;rbol </td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  <tr>\r\n");
      out.write("    <td class=\"TituloTabla\">&Aacute;rbol de Mis Accesos </td>\r\n");
      out.write("  </tr>\r\n");
      out.write("  <tr>\r\n");
